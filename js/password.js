...
function renderForgotPassword() {
  ...
  function renderForgotPasswordHTML() {
    ...
    const goBackImage = isSmall ? "./assets/img/go-back.png" : "./assets/img/go-back-arrow-blue.png";
  
    return /*html*/ `<img class="${imageClass}" src="./assets/img/LogoJoinBig.png" alt="Logo">
  
    <div class="big-container">
         <form class="password-container">
             <a href="index.html"><img class="go-back-arrow" src="${goBackImage}" onclick="history.back()"></a>
  ...
  function renderResetPasswordHTML() {
   ...
   <div class="big-container">
       <form class="password-container">
           <a href="#"><img class="go-back-arrow" src="${goBackImage}" alt="go back" onclick="renderForgotPassword()"></a>
